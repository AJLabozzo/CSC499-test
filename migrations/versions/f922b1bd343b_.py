...
Revision ID: f922b1bd343b
Revises: 
Create Date: 2019-10-06 21:09:58.759881
...
def upgrade():
    ...
    op.create_index(op.f('ix_project_department'), 'project', ['department'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_project_department'), table_name='project')
